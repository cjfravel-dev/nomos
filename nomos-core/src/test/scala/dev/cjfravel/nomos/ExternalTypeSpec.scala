...
class ExternalTypeSpec extends AnyFlatSpec with Matchers with EitherValues {
  ...
  "parser" should "parse $extern into an ExternalType" in {
    ...
    d.templateType.asInstanceOf[ObjectType].fields("rules").fieldType shouldBe ArrayType(
      ExternalType("com.example.legacy.Rule"))
  }
  ...
  "generator" should "emit the fully-qualified external type" in {
    ...
    new CodeGenerator(GeneratorConfig("com.example", "target/test-gen"))
      ...
      .get
      .content should include("rule: com.example.legacy.Rule")
  }
  ...
  "parser" should "parse $gen into a generated external type" in {
    ...
    d.templateType.asInstanceOf[ObjectType].fields("owner").fieldType shouldBe ExternalType(
      "com.other.models.Owner",
      generated = true)
  }
  ...
  "serializer" should "round-trip an external type" in {
    TemplateSerializer.serializeTemplateType(
      ExternalType("com.x.Y")) shouldBe "ExternalType(\"com.x.Y\", generated = false)"
    TemplateSerializer.serializeTemplateType(
      ExternalType("com.x.Y", generated = true)) shouldBe "ExternalType(\"com.x.Y\", generated = true)"
  }
}
