...
class BoxedNullableSpec extends AnyFlatSpec with Matchers {
  ...
  "a nullable numeric field" should "deserialize a present value and default to null when absent" in {
    Limits.fromJson("""{"name":"a","attributes":{},"maxFiles":5}""").right.get.maxFiles shouldBe (5: java.lang.Integer)
    Limits.fromJson("""{"name":"a","attributes":{}}""").right.get.maxFiles shouldBe null
  }
}
