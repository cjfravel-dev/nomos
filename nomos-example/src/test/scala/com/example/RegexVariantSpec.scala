...
class RegexVariantSpec extends AnyFlatSpec with Matchers {

  "a regex discriminator" should "validate and deserialize a parameterized value" in {
  ...
  it should "reject malformed and unknown discriminator values" in {
    Column.fromJson("""{"type":"Decimal(28,8","scale":8}""").isLeft shouldBe true
